      ...
      <div className="w-full max-w-[1000px] py-10 px-4 md:px-0">
        ...
        <div className=" bg-[#F8F5EC] text-primary p-8 text-center">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a href="/calgary/finalstep/residential" className="bg-tertiary px-6 py-3 font-bold rainbow-button !rounded-xl text-center">
              GET A FREE QUOTE
            </a>
            <a href="tel:5878125952" className="bg-tertiary text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center">
