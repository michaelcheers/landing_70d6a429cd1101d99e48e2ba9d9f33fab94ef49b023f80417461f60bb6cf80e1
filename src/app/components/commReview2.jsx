    ...
    return (
        <>
                <div className="hidden md:flex justify-center flex-col w-full">
                    ...
                    <div className="pb-10 w-[1400px] mx-auto max-w-[1400px] rounded-4xl">
                            <div className="flex flex-col justify-center items-center">
                                {/* Review Carousel */}
                                <div className="mx-5 flex justify-center mt-10 ">
                                    <div className="flex flex-col items-center justify-center p-0">
                                        <div className="flex items-center w-full">
                                            ...
                                            {
                                                currentSlide > 0 && (
                                                    <button onClick={handlePrev} className="text-white cursor-pointer flex-shrink-0">
                                                        <ArrowLeftCircleIcon className="h-12 w-12" />
                                                    </button>
                                                )
                                            }
                                            <div className="flex gap-x-4 w-full justify-center overflow-hidden pb-3">
                                                <div 
                                                ...
                                                >
                                                    {carouselItems.map((item, index) => (
                                                        ...
                                                        >
                                                            <div className="border-1 border-white flex flex-col h-[400px] bg-primary">
                                            ...
                                            </div>
                                            {
                                                currentSlide < carouselItems.length-4 &&(
                                                    <button onClick={handleNext} className="text-white cursor-pointer flex-shrink-0">
            ...
            <div className="md:hidden w-full py-10 rounded-4xl">
                ...
                <div className="w-[280px] h-[400px] mx-auto">
                    ...
                    >
                        {carouselItems.map((item, index) => (
                                                ...
                                                >
                                                    <div className="border-1 border-white  p-4 flex flex-col h-[400px] bg-primary">
                                                        <div className="mb-1">
