...
function Header({ section = "residential" }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: `transition-all duration-300 ${bgColor} border-b-1`, children: [
    /* @__PURE__ */ jsx("div", { className: "hidden md:flex justify-center", children: /* @__PURE__ */ jsxs("div", { className: "h-20 flex md:w-[1300px]", children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center h-20 w-70", children: /* @__PURE__ */ jsx(Link, { href: "/calgary", className: "flex items-center", children: /* @__PURE__ */ jsx(Image, { src: headerlogo, alt: "Moving Papa Logo", priority: true }) }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: `flex gap-x-8`, children: [
          /* @__PURE__ */ jsxs("div", { className: "group relative", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "absolute hidden group-hover:block z-1000", children: /* @__PURE__ */ jsxs("div", { className: `space-y-2 mt-2 ${dropdownBgColor} ${dropdownTextColor} p-3 border-2 ${dropdownBorderColor} rounded-md shadow-lg w-60 flex flex-col`, children: [
              ...
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/residential", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Residential Moving" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/packing", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Packing" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/storage", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Storage" }),
              /* @__PURE__ */ jsx("div", { className: "font-bold border-b border-gray-300 pb-2 mb-2 mt-3", children: "Commercial" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/commercial", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2 font-semibold", children: "Commercial Overview" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/warehouse", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Warehouse" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/office", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Office" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/specialEquipment", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Special Equipment" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/art", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Art" }),
              /* @__PURE__ */ jsx(Link, { href: "/calgary/service/lastmile", className: "hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2", children: "Last Mile" })
            ] }) })
          ] }),
          /* @__PURE__ */ jsx(Link, { href: "/calgary/areas-of-service", className: "hover:underline", children: "Areas of Service" }),
          /* @__PURE__ */ jsx(Link, { href: "/calgary/reviews", className: "hover:underline", children: "Reviews" }),
          /* @__PURE__ */ jsx(Link, { href: "/calgary/blog", className: "hover:underline", children: "Blogs" }),
          /* @__PURE__ */ jsx(Link, { href: "/calgary/company", className: "hover:underline", children: "Company" })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-end gap-x-5 ml-5", children: [
          /* @__PURE__ */ jsx("div", { className: `flex-col w-40 border-r-3 pr-4 ${borderColor}`, children: /* @__PURE__ */ jsx(Link, { href: `tel:5878125952`, children: /* @__PURE__ */ jsx("button", { className: `w-full h-10 flex justify-center items-center hover:cursor-pointer border-2 border-tertiary rounded-xl text-sm ${bgColor} ${butTextColor} ${hoverTextColor} ${hoverBackgd}`, children: "587-812-5952" }) }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: `flex md:hidden items-center px-4 py-2 ${bgColor} ${textColor}`, children: [
      /* @__PURE__ */ jsx("div", { className: "flex items-center h-13 w-40", children: /* @__PURE__ */ jsx(Link, { href: "/calgary", children: /* @__PURE__ */ jsx(Image, { src: headerlogo, alt: "Moving Papa Logo", priority: true }) }) }),
      /* @__PURE__ */ jsxs("div", { className: "flex-grow flex justify-end items-center gap-x-2", children: [
        /* @__PURE__ */ jsx("a", { href: "tel:5878125952", children: /* @__PURE__ */ jsx("button", { className: `${phoneBorderColor} border-1 flex justify-center items-center p-1 rounded-md ${bgColor}`, children: /* @__PURE__ */ jsx(PhoneIcon, { className: `h-5 w-5 ${phoneIconColor}`, strokeWidth: 2 }) }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mb-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-3 mb-3", children: [
          ...
          /* @__PURE__ */ jsxs("ul", { className: "ml-4 space-y-2 flex flex-col", children: [
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/residential", onClick: () => setMenuOpen(false), children: "Residential Moving" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/packing", onClick: () => setMenuOpen(false), children: "Packing" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/storage", onClick: () => setMenuOpen(false), children: "Storage" })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "border-t border-gray-400 pt-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsx(Link, { href: "/calgary/commercial", onClick: () => setMenuOpen(false), className: "font-bold ml-4", children: "Commercial Overview" }) }),
          /* @__PURE__ */ jsxs("ul", { className: "ml-4 space-y-2 flex flex-col", children: [
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/warehouse", onClick: () => setMenuOpen(false), children: "Warehouse" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/office", onClick: () => setMenuOpen(false), children: "Office" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/specialEquipment", onClick: () => setMenuOpen(false), children: "Special Equipment" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/art", onClick: () => setMenuOpen(false), children: "Art" }),
            /* @__PURE__ */ jsx(Link, { href: "/calgary/service/lastmile", onClick: () => setMenuOpen(false), children: "Last Mile" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "mb-4 border-t border-gray-400 pt-3", children: /* @__PURE__ */ jsx(Link, { href: "/calgary/areas-of-service", onClick: () => setMenuOpen(false), className: "font-bold", children: "Areas of Service" }) }),
      /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx(Link, { href: "/calgary/reviews", onClick: () => setMenuOpen(false), className: "font-bold", children: "Reviews" }) }),
      /* @__PURE__ */ jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsx(Link, { href: "/calgary/blog", onClick: () => setMenuOpen(false), className: "font-bold", children: "Blogs" }) }),
      /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(Link, { href: "/calgary/company", onClick: () => setMenuOpen(false), className: "font-bold", children: "Company" }) })
    ] })
  ] });
}
export {
