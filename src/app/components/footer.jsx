...
export default function Footer() {
    ...
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:w-[1200px]">
                ...
                <div className="col-span-1 md:col-span-2 text-white text-sm">
                    <div className="mb-6">
                        ...
                        <Link href="/service/residential">Residential Moving</Link>
                        <Link href="/service/packing">Packing</Link>
                        <Link href="/service/storage">Storage</Link>
                        </ul>
                    </div>
                    <div className="mb-6">
                        <h3 className="font-bold pb-2 border-b-2 pl-2 border-white">
                        <Link href="/commercial">Commercial Moving</Link>
                        </h3>
                        <ul className="mt-4 space-y-2  pl-2 flex gap-x-20 text-regular">
                        <Link href="/service/warehouse">Warehouse</Link>
                        <Link href="/service/office">Office</Link>
                        <Link href="/service/specialEquipment">Special Equipment</Link>
                        <Link href="/service/art">Art</Link>
                        <Link href="/service/lastmile">Last Mile</Link>
                        </ul>
                    </div>
                    ...
                    <div className="flex">
                        <div className="flex flex-col gap-y-5 my-5 pl-2 text-sm text-[13px] w-1/2">
                            <div className="flex items-center">
                                <ClockIcon className="h-5 w-5"/>
                                <div className="pl-1">
                                    <div>Mon-Fri: 8am - 11pm</div>
                                    <div>Sat-Sun: 9am - 9pm</div>
                                </div>
                            </div>
                            <div className="flex items-center">
                                <MapPinIcon className="h-5 w-5"/>
                                <span className="pl-1">200 Fairbank Ave, York, ON M6B 1G1</span>
                            </div>
                            <div className="flex items-center">
                                <Link href={`tel:6472518188`} className="flex">
                                    <PhoneIcon className="h-5 w-5"/>
                                    <span className="pl-1">(647) 251-8188</span>
                                </Link>
                            </div>
                            <div className="flex items-center">
                                <Link href={`mailto:hello@movingpapa.com`} className="flex">
                                    <EnvelopeIcon className="h-5 w-5"/>
                                    <span className="pl-1">hello@movingpapa.com</span>
                                </Link>
                            </div>
                        ...
                        <div className="w-full flex justify-end">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2884.476982539531!2d-79.45796712336788!3d43.700635649360926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b334a4c29e2a1%3A0x4c25725f41f4dc45!2sMoving%20Papa%20-%20Movers%20Toronto!5e0!3m2!1sen!2sca!4v1748288126772!5m2!1sen!2sca" width="500" height="200" style={{border:0}} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>                     
                    </div>
        ...
        <div className="sm:hidden bg-[#06170e] flex justify-center flex-wrap pt-6 pl-2">
            ...
            <div className="pb-5">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2884.476982539531!2d-79.45796712336788!3d43.700635649360926!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x882b334a4c29e2a1%3A0x4c25725f41f4dc45!2sMoving%20Papa%20-%20Movers%20Toronto!5e0!3m2!1sen!2sca!4v1748288126772!5m2!1sen!2sca" width="300" height="200" style={{border:0}} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
                {/* Bottom Section */}
            <div className="w-full bg-[#06170e] text-white text-xs px-4 py-4 border-t border-white">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex ">
                        ...
                        <Link href={"/terms-and-condition"} className="border-l-1 pl-5">
                            Terms and Condition                        
                        </Link>                        
                    </div>
                </div>
