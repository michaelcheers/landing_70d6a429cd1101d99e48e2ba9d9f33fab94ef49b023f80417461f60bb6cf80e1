        ...
        {/* Desktop Header */}
            <div className="hidden md:flex justify-center">
                ...
                <div className="flex items-center h-20 w-70">
                    <Link href="/ottawa" className="flex items-center">
                        ...
                        <div className={`flex gap-x-8`}>
                            <div className="group relative">
                                ...
                                <div className={`space-y-2 mt-2 ${dropdownBgColor} ${dropdownTextColor} p-3 border-2 ${dropdownBorderColor} rounded-md shadow-lg w-60 flex flex-col`}>
                                    ...
                                    <Link href="/ottawa/service/residential" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Residential Moving</Link>
                                    <Link href="/ottawa/service/packing" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Packing</Link>
                                    <Link href="/ottawa/service/storage" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Storage</Link>

                                    {/* Commercial Services */}
                                    <div className="font-bold border-b border-gray-300 pb-2 mb-2 mt-3">Commercial</div>
                                    <Link href="/ottawa/commercial" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2 font-semibold">Commercial Overview</Link>
                                    <Link href="/ottawa/service/warehouse" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Warehouse</Link>
                                    <Link href="/ottawa/service/office" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Office</Link>
                                    <Link href="/ottawa/service/specialEquipment" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Special Equipment</Link>
                                    <Link href="/ottawa/service/art" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Art</Link>
                                    <Link href="/ottawa/service/lastmile" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Last Mile</Link>
                                </div>
                                </div>
                            </div>
                            <Link href="/ottawa/areas-of-service" className='hover:underline'>Areas of Service</Link>
                            <Link href="/ottawa/reviews" className='hover:underline'>Reviews</Link>
                            <Link href="/ottawa/blog" className='hover:underline'>Blogs</Link>
                            <Link href="/ottawa/company" className='hover:underline'>Company</Link>
                        </div>
                        <div className="flex items-end gap-x-5 ml-5">
                            <div className={`flex-col w-40 border-r-3 pr-4 ${borderColor}`}>
                                <Link href={`tel:3435000488`}>
                ...
                <div className="mb-4">
                    ...
                    <div className="mt-3 mb-3">
                        ...
                        <ul className="ml-4 space-y-2 flex flex-col">
                            <Link href="/ottawa/service/residential" onClick={() => setMenuOpen(false)}>Residential Moving</Link>
                            <Link href="/ottawa/service/packing" onClick={() => setMenuOpen(false)}>Packing</Link>
                            <Link href="/ottawa/service/storage" onClick={() => setMenuOpen(false)}>Storage</Link>
                        </ul>
                    </div>
                    ...
                    <div className="border-t border-gray-400 pt-3">
                        ...
                        <div className="mb-2">
                            <Link href="/ottawa/commercial" onClick={() => setMenuOpen(false)} className="font-bold ml-4">
                                Commercial Overview
                            </Link>
                        </div>
                        <ul className="ml-4 space-y-2 flex flex-col">
                            <Link href="/ottawa/service/warehouse" onClick={() => setMenuOpen(false)}>Warehouse</Link>
                            <Link href="/ottawa/service/office" onClick={() => setMenuOpen(false)}>Office</Link>
                            <Link href="/ottawa/service/specialEquipment" onClick={() => setMenuOpen(false)}>Special Equipment</Link>
                            <Link href="/ottawa/service/art" onClick={() => setMenuOpen(false)}>Art</Link>
                            <Link href="/ottawa/service/lastmile" onClick={() => setMenuOpen(false)}>Last Mile</Link>
                        </ul>
                    </div>
                </div>

                <div className="mb-4 border-t border-gray-400 pt-3">
                    <Link href="/ottawa/areas-of-service" onClick={() => setMenuOpen(false)} className="font-bold">Areas of Service</Link>
                </div>
                <div className="mb-4">
                    <Link href="/ottawa/reviews" onClick={() => setMenuOpen(false)} className="font-bold">Reviews</Link>
                </div>
                <div className="mb-4">
                    <Link href="/ottawa/blog" onClick={() => setMenuOpen(false)} className="font-bold">Blogs</Link>
                </div>
                <div>
                    <Link href="/ottawa/company" onClick={() => setMenuOpen(false)} className="font-bold">Company</Link>
                </div>
                </div>
            )}
        </div>
