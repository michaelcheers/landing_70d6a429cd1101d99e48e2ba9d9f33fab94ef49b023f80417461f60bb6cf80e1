            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:w-[1200px]">
                ...
                <div className="col-span-1 md:col-span-2 text-white text-sm">
                    <div className="mb-6">
                        ...
                        <Link href="/ottawa/service/residential">Residential Moving</Link>
                        <Link href="/ottawa/service/packing">Packing</Link>
                        <Link href="/ottawa/service/storage">Storage</Link>
                        </ul>
                    </div>
                    <div className="mb-6">
                        <h3 className="font-bold pb-2 border-b-2 pl-2 border-white">
                        <Link href="/ottawa/commercial">Commercial Moving</Link>
                        </h3>
                        <ul className="mt-4 space-y-2  pl-2 flex gap-x-20 text-regular">
                        <Link href="/ottawa/service/warehouse">Warehouse</Link>
                        <Link href="/ottawa/service/office">Office</Link>
                        <Link href="/ottawa/service/specialEquipment">Special Equipment</Link>
                        <Link href="/ottawa/service/art">Art</Link>
                        <Link href="/ottawa/service/lastmile">Last Mile</Link>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <Link href="/ottawa/company">About Us</Link>
                        <Link href="/ottawa/reviews">Reviews</Link>
                        </ul>
                    </div>
                    <div className="flex">
                        <div className="flex flex-col gap-y-5 my-5 pl-2 text-sm text-[13px] w-full">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="pl-1">123 Wellington Street, Ottawa, ON K1A 0A9</span>
                            </div>
                            <div className="flex items-center">
                                <Link href={`tel:3435000488`} className="flex">
                                    <PhoneIcon className="h-5 w-5"/>
                                    <span className="pl-1">(343) 500-0488</span>
                                </Link>
                            </div>
                            <div className="flex items-center">
                                <Link href={`mailto:ottawa@movingpapa.com`} className="flex">
                                    <EnvelopeIcon className="h-5 w-5"/>
                                    <span className="pl-1">ottawa@movingpapa.com</span>
                                </Link>
                            </div>
                    ...
                    <div className="flex items-center py-2 pl-2 gap-x-10 text-[12px] pt-10">
                        ...
                        <div className="border-l-1 pl-10">
                                <Link href="/ottawa/privacy-policy">
                                    Privacy Policy
                                </Link>
                            </div>
                            <div className="border-l-1 pl-10">
                            <Link href="/ottawa/terms-and-condition">
                                Terms and Condition
                            </Link>
                        </div>
                    </div>
        ...
        <div className="sm:hidden bg-[#06170e] flex justify-center flex-wrap pt-6 pl-2">
                ...
                <div className="col-span-1 text-white text-sm pb-6 border-t-2 pt-5">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center">
                            <MapPinIcon className="h-5 w-5" />
                            <span className="pl-2">
                                123 Wellington Street, Ottawa, ON K1A 0A9
                            </span>
                        </div>
                        <div className="flex items-center">
                            <Link href={`tel:3435000488`} className="flex">
            ...
            <div className="w-full bg-[#06170e] text-white text-xs px-4 py-4 border-t border-white">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex ">
                        <Link href="/ottawa/privacy-policy" className="pr-5">
                            Privacy Policy
                        </Link>
                        <Link href="/ottawa/terms-and-condition" className="border-l-1 pl-5">
                            Terms and Condition
                        </Link>
                    </div>
                </div>
