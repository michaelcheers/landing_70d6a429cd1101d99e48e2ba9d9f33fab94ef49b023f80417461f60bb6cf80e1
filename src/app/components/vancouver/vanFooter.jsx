            ...
            <div className="grid grid-cols-1 md:grid-cols-3 md:w-[1200px]">
                ...
                <div className="col-span-1 md:col-span-2 text-white text-sm">
                    <div className="mb-6">
                        ...
                        <Link href="/vancouver/service/residential">Residential Moving</Link>
                        <Link href="/vancouver/service/packing">Packing</Link>
                        <Link href="/vancouver/service/storage">Storage</Link>
                        </ul>
                    </div>
                    <div className="mb-6">
                        <h3 className="font-bold pb-2 border-b-2 pl-2 border-white">
                        <Link href="/vancouver/commercial">Commercial Moving</Link>
                        </h3>
                        <ul className="mt-4 space-y-2  pl-2 flex gap-x-20 text-regular">
                        <Link href="/vancouver/service/warehouse">Warehouse</Link>
                        <Link href="/vancouver/service/office">Office</Link>
                        <Link href="/vancouver/service/specialEquipment">Special Equipment</Link>
                        <Link href="/vancouver/service/art">Art</Link>
                        <Link href="/vancouver/service/lastmile">Last Mile</Link>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <Link href="/vancouver/company">About Us</Link>
                        <Link href="/vancouver/reviews">Reviews</Link>
                        </ul>
                    </div>
                    <div className="flex">
                        <div className="flex flex-col gap-y-5 my-5 pl-2 text-sm text-[13px] w-full">
                            ...
                            <div className="flex items-center">
                                ...
                                <span className="pl-1">33 Commercial Drive, Vancouver, BC V5L 0A2</span>
                            </div>
                            <div className="flex items-center">
                                <Link href={`tel:6043735582`} className="flex">
                                    <PhoneIcon className="h-5 w-5"/>
                                    <span className="pl-1">(604)-373-5582</span>
                                </Link>
                            </div>
                            <div className="flex items-center">
                                <Link href={`mailto:Vancouver@movingpapa.com`} className="flex">
                                    <EnvelopeIcon className="h-5 w-5"/>
                                    <span className="pl-1">Vancouver@movingpapa.com</span>
                                </Link>
                            </div>
                        ...
                        <div className="w-full flex justify-end">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5205.198190638983!2d-123.0734002231348!3d49.28399337066075!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x5486713a8a1101ad%3A0xfdd5c58806c4e28f!2sMOVING%20PAPA!5e0!3m2!1sen!2sca!4v1748615545509!5m2!1sen!2sca" width="400" height="200" style={{border:0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                        </div>                     
                    </div>
                    ...
                    <div className="flex items-center py-2 pl-2 gap-x-10 text-[12px] pt-10">
                        ...
                        <div className="border-l-1 pl-10">
                                <Link href="/vancouver/privacy-policy">
                                    Privacy Policy
                                </Link>
                            </div>
                            <div className="border-l-1 pl-10">
                            <Link href="/vancouver/terms-and-condition">
                                Terms and Condition
                            </Link>
                        </div>                       
                    </div>
        ...
        <div className="sm:hidden bg-[#06170e] flex justify-center flex-wrap pt-6 pl-2">
            ...
            <div className="w-full bg-[#06170e] text-white text-xs px-4 py-4 border-t border-white">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex ">
                        <Link href="/vancouver/privacy-policy" className="pr-5">
                            Privacy Policy
                        </Link>
                        <Link href="/vancouver/terms-and-condition" className="border-l-1 pl-5">
                            Terms and Condition
                        </Link>
                    </div>
                </div>
