...
// import headerLogo from '/src/images/headerlogonew2.svg'
        ...
        {/* Desktop Header */}
            <div className="hidden md:flex justify-center">
                ...
                <div className="flex items-center h-20 w-70">
                    <Link href="/vancouver" className="flex items-center">
                        ...
                        <div className={`flex gap-x-8`}>
                            <div className="group relative">
                                ...
                                <div className={`space-y-2 mt-2 ${dropdownBgColor} ${dropdownTextColor} p-3 border-2 ${dropdownBorderColor} rounded-md shadow-lg w-60 flex flex-col`}>
                                    ...
                                    <Link href="/vancouver/service/residential" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Residential Moving</Link>
                                    <Link href="/vancouver/service/packing" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Packing</Link>
                                    <Link href="/vancouver/service/storage" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Storage</Link>
                                    
                                    {/* Commercial Services */}
                                    <div className="font-bold border-b border-gray-300 pb-2 mb-2 mt-3">Commercial</div>
                                    <Link href="/vancouver/commercial" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2 font-semibold">Commercial Overview</Link>
                                    <Link href="/vancouver/service/warehouse" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Warehouse</Link>
                                    <Link href="/vancouver/service/office" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Office</Link>
                                    <Link href="/vancouver/service/specialEquipment" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Special Equipment</Link>
                                    <Link href="/vancouver/service/art" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Art</Link>
                                    <Link href="/vancouver/service/lastmile" className="hover:pl-2 transition-all duration-200 no-underline hover:underline ml-2">Last Mile</Link>
                                </div>
                                </div>
                            </div>
                            <Link href="/vancouver/areas-of-service" className='hover:underline'>Areas of Service</Link>
                            <Link href="/vancouver/reviews" className='hover:underline'>Reviews</Link>
                            <Link href="/vancouver/blog" className='hover:underline'>Blogs</Link>
                            <Link href="/vancouver/company" className='hover:underline'>Company</Link>
                        </div>
                        <div className="flex items-end gap-x-5 ml-5">
                            <div className={`flex-col w-40 border-r-3 pr-4 ${borderColor}`}>
                                <Link href={`tel:6043735582`}>
                ...
                <div className="mb-4">
                    ...
                    <div className="mt-3 mb-3">
                        ...
                        <ul className="ml-4 space-y-2 flex flex-col">
                            <Link href="/vancouver/service/residential" onClick={() => setMenuOpen(false)}>Residential Moving</Link>
                            <Link href="/vancouver/service/packing" onClick={() => setMenuOpen(false)}>Packing</Link>
                            <Link href="/vancouver/service/storage" onClick={() => setMenuOpen(false)}>Storage</Link>
                        </ul>
                    </div>
                    ...
                    <div className="border-t border-gray-400 pt-3">
                        ...
                        <div className="mb-2">
                            <Link href="/vancouver/commercial" onClick={() => setMenuOpen(false)} className="font-bold ml-4">
                                Commercial Overview
                            </Link>                        
                        </div>
                        <ul className="ml-4 space-y-2 flex flex-col">
                            <Link href="/vancouver/service/warehouse" onClick={() => setMenuOpen(false)}>Warehouse</Link>
                            <Link href="/vancouver/service/office" onClick={() => setMenuOpen(false)}>Office</Link>
                            <Link href="/vancouver/service/specialEquipment" onClick={() => setMenuOpen(false)}>Special Equipment</Link>
                            <Link href="/vancouver/service/art" onClick={() => setMenuOpen(false)}>Art</Link>
                            <Link href="/vancouver/service/lastmile" onClick={() => setMenuOpen(false)}>Last Mile</Link>                        
                        </ul>
                    </div>
                </div>

                <div className="mb-4 border-t border-gray-400 pt-3">
                    <Link href="/vancouver/areas-of-service" onClick={() => setMenuOpen(false)} className="font-bold">Areas of Service</Link>
                </div>
                <div className="mb-4">
                    <Link href="/vancouver/reviews" onClick={() => setMenuOpen(false)} className="font-bold">Reviews</Link>
                </div>
                <div className="mb-4">
                    <Link href="/vancouver/blog" onClick={() => setMenuOpen(false)} className="font-bold">Blogs</Link>
                </div>
                <div>
                    <Link href="/vancouver/company" onClick={() => setMenuOpen(false)} className="font-bold">Company</Link>
                </div>
                </div>
            )}
        </div>
