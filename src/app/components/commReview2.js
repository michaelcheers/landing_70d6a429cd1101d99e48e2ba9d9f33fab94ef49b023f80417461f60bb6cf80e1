...
function Review() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "hidden md:flex justify-center flex-col w-full", children: /* @__PURE__ */ jsx("div", { className: "pb-10 w-[1400px] mx-auto max-w-[1400px] rounded-4xl", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-center items-center", children: /* @__PURE__ */ jsx("div", { className: "mx-5 flex justify-center mt-10 ", children: /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center p-0", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center w-full", children: [
      currentSlide + 1 == 0 && /* @__PURE__ */ jsx("div", { className: "h-12 w-12 flex-shrink-0" }),
      currentSlide > 0 && /* @__PURE__ */ jsx("button", { onClick: handlePrev, className: "text-white cursor-pointer flex-shrink-0", children: /* @__PURE__ */ jsx(ArrowLeftCircleIcon, { className: "h-12 w-12" }) }),
      /* @__PURE__ */ jsx("div", { className: "flex gap-x-4 w-full justify-center overflow-hidden pb-3", children: /* @__PURE__ */ jsx(
        "div",
        {
          className: "flex transition-transform duration-500 ease-in-out max-w-[1300px]",
          style: {
          ...
          children: carouselItems.map((item, index) => /* @__PURE__ */ jsx(
            "div",
            {
              className: "w-1/4 flex-shrink-0 px-1 max-w-[325px]",
              children: /* @__PURE__ */ jsx("div", { className: "border-1 border-white flex flex-col h-[400px] bg-primary", children: /* @__PURE__ */ jsxs("div", { className: "p-4 flex flex-col h-full", children: [
      ...
      currentSlide < carouselItems.length - 4 && /* @__PURE__ */ jsx("button", { onClick: handleNext, className: "text-white cursor-pointer flex-shrink-0", children: /* @__PURE__ */ jsx(ArrowRightCircleIcon, { className: "h-12 w-12" }) }),
      currentSlide >= carouselItems.length - 4 && /* @__PURE__ */ jsx("div", { className: "h-12 w-12 flex-shrink-0" })
    ] }) }) }) }) }) }),
    /* @__PURE__ */ jsx("div", { className: "md:hidden w-full py-10 rounded-4xl", children: /* @__PURE__ */ jsxs("div", { className: "w-full text-center relative overflow-hidden mx-auto", children: [
        ...
        "div",
        {
          ...
          children: carouselItems.map((item, index) => /* @__PURE__ */ jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxs("div", { className: "border-1 border-white  p-4 flex flex-col h-[400px] bg-primary", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center mt-4 space-x-3", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "flex justify-center space-x-2", children: carouselItems.map((_, index) => /* @__PURE__ */ jsx(
          "div",
          {
            className: `h-2 w-2 rounded-full ${currentSlide === index ? "bg-tertiary" : "bg-white bg-opacity-50"}`,
            onClick: () => {
              if (!isAnimating) {
                setIsAnimating(true);
