...
export default function GetQuote({ from }: GetQuoteProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      // // Check if destination is required based on service type
      // const isDestinationRequired = (from === "moving" || from === "landing" || from === "vancouver-moving");
      
      // if (isDestinationRequired && !destinationAddress) {
      //   alert("Please enter a destination address before getting a quote.");
      //   return;
      // }

      // If validation passes, navigate to appropriate finalstep
    ...
    return(
      <>
          ...
          <div className="md:w-[600px] bg-primary rounded-3xl shadow-lg">
            {/* Header */}
            <div className="flex w-full justify-center py-4  gap-x-2 md:gap-x-5 border-b-1 text-[10px] md:text-[12px] gap-y-2 border-white">
                  <div className="flex items-center py-1 px-2 bg-primary text-white drop-shadow-lg/30 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-[18px] md:h-[18px]" viewBox="0 0 10 11" fill="none">
                        <circle cx="5.02296" cy="4.26725" r="3.06172" stroke="white" strokeWidth="0.612417"/>
                        <path fillRule="evenodd" clipRule="evenodd" d="M5.02307 5.03289L4.12324 5.50596L4.29509 4.50398L3.56711 3.79438L4.57315 3.6482L5.02307 2.73657L5.47298 3.6482L6.47902 3.79438L5.75104 4.50398L5.92289 5.50596L5.02307 5.03289Z" stroke="white" strokeWidth="0.612417" strokeLinejoin="round"/>
                        <path d="M5.32959 7.32955L6.55429 9.16661L7.16664 7.9419H9.0037L7.77899 5.79868" stroke="white" strokeWidth="0.612417" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M4.71704 7.32955L3.49234 9.16661L2.87999 7.9419H1.04293L2.26764 5.79868" stroke="white" strokeWidth="0.612417" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      Fully Protected
                    </div>
                  <div className="flex items-center py-1 px-2 bg-primary text-white drop-shadow-lg/30 rounded-md">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-[18px] md:h-[18px] text-white"  viewBox="0 0 13 13" fill="none">
                      <path d="M5.01392 6.5652L6.20698 7.75827L8.44398 5.52127" stroke="white" strokeWidth="0.745665" strokeLinecap="round" strokeLinejoin="round"/>
                  ...
                  <div className="flex items-center py-1 px-2 bg-primary text-white drop-shadow-lg/30 rounded-md">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 md:w-[18px] md:h-[18px]"  viewBox="0 0 10 10" fill="none">
                      <path d="M7.01999 7.02724C5.15742 8.51729 3.25525 7.70296 2.38646 7.02724C1.80727 6.15845 0.938481 3.55209 3.54484 3.26249C5.58007 3.03635 6.73039 2.10411 7.59918 1.23532C8.46797 3.26249 8.46797 5.86885 7.01999 7.02724Z" stroke="white" strokeWidth="0.579191" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M1.22803 8.18566C1.4597 7.7223 2.09681 7.22034 2.38641 7.02727C4.41358 7.02727 6.15115 6.15849 6.44075 4.13132" stroke="white" strokeWidth="0.579191" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    Sustainable
                  </div>
            </div>
            <div className="text-center py-3 md:py-6">
              <h2 className="text-white text-xl font-bold hidden md:block">Where are you moving to?</h2>
              <h2 className="md:hidden text-white text-xl font-bold">Get a Free Quote Within Minutes</h2>
            </div>
            <div className="w-full hidden md:flex justify-center">
              <div className="w-full flex my-4 justify-center">
                {/* Left wing - increased size by 30% */}
                <div className="relative h-20 aspect-[420/740] mr-2">
                  <Image src={reviewtagleft} alt="Review tag left" fill priority sizes="" />
                </div>

                {/* Review box - increased size proportionally */}
                <div className="relative h-20">
                  <div className="w-full h-full flex bg-white p-2 py-3 rounded-md border-t-1 border-primary pr-3"
                        style={{
                      ...
                      <div>
                        <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 34 34" fill="none">
                      ...
                      <div className="text-[14px] pl-3 font-bold">
                        <div className="">Google Top Rated Service</div>
                        <div className="text-[#FEA500] text-lg flex font-bold">4.9
                ...
                <div className="relative h-20 aspect-[420/740] ml-2">
            ...
            <div className="relative flex flex-col items-center pt-4">
              {/* Connecting line - positioned absolutely to connect the circles */}

              {/* Desktop line*/}
              <div className="hidden w-9/10 md:flex justify-start relative">
                <div className="absolute z-50 top-3 left-[27px]">
                  <svg width="8" height="80" viewBox="0 0 8 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <defs>
                      <linearGradient id="paint0_linear_4_35" x1="4" y1="0" x2="4" y2="60" gradientUnits="userSpaceOnUse">
                        <stop stopColor="#012122"/>
                        <stop offset="1" stopColor="#F84734"/>
                      </linearGradient>
                    </defs>
                    <line x1="4" y1="15" x2="4" y2="52" 
              ...
              {/* mobile line */}
              <div className="md:hidden w-[350px] flex justify-start relative z-40">
                <div className="absolute top-8 left-[27px] ">
              ...
              <div className="relative mb-5 md:mb-4 w-[350px] md:w-9/10">
                <div className="flex items-center bg-[#F8F5EC] rounded-full px-4 py-2 shadow-sm">
                    <svg width="30" height="30" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M51.0295 25.6806C51.0295 39.2766 40.0078 50.2983 26.4118 50.2983C12.8158 50.2983 1.79409 39.2766 1.79409 25.6806C1.79409 12.0846 12.8158 1.06284 26.4118 1.06284C40.0078 1.06284 51.0295 12.0846 51.0295 25.6806Z" fill="white" stroke="white" strokeWidth="1.82353"></path>
                        <path d="M26.4119 43.9159C36.483 43.9159 44.6472 35.7517 44.6472 25.6806C44.6472 15.6095 36.483 7.44524 26.4119 7.44524C16.3408 7.44524 8.17651 15.6095 8.17651 25.6806C8.17651 35.7517 16.3408 43.9159 26.4119 43.9159Z" stroke="#00292A" strokeWidth="14.5883"></path>
                    </svg>
              ...
              {
                (from == "storage" || from == "vancouver-storage" || from == "ottawa-storage" || from == "calgary-storage" || from == "edmonton-storage") &&
                   <div className="relative w-[350px] md:w-9/10">
                    <div className="flex items-center bg-[#F8F5EC] rounded-full px-4 py-2 shadow-sm">
                        <svg width="30" height="30" viewBox="0 0 41 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.4118 51.9162C18.3877 51.9162 8.77587 40.0341 6.42169 36.2101C2.90409 30.497 0.781494 27.0469 0.781494 20.4876C0.781494 15.2813 2.84969 10.2883 6.53109 6.60687C10.2125 2.92546 15.2056 0.857269 20.4118 0.857269C25.6181 0.857269 30.6112 2.92546 34.2926 6.60687C37.974 10.2883 40.0422 15.2813 40.0422 20.4876C40.0422 26.7825 37.9451 30.1834 34.4695 35.8181L34.2288 36.2101C31.8035 40.1417 22.3959 51.9162 20.4118 51.9162ZM20.4118 10.6734C18.4704 10.6734 16.5726 11.2491 14.9583 12.3277C13.3441 13.4063 12.0859 14.9393 11.343 16.733C10.6 18.5266 10.4056 20.5003 10.7844 22.4045C11.1631 24.3086 12.098 26.0577 13.4708 27.4305C14.8436 28.8033 16.5927 29.7382 18.4968 30.1169C20.401 30.4957 22.3746 30.3013 24.1683 29.5583C25.962 28.8154 27.495 27.5572 28.5736 25.943C29.6522 24.3287 30.2279 22.4309 30.2279 20.4894C30.225 17.8869 29.1899 15.3919 27.3497 13.5516C25.5094 11.7114 23.0143 10.6763 20.4118 10.6734Z" fill="#F84734"></path>
                        </svg>
                      <div className="flex-1 font-bold pl-2 text-sm md:text-base">
                        Moving Papa Storage
                      </div>
                    </div>
                  </div>                   
            ...
            {/* Buttons Section */}
            <div className="py-6 flex flex-col items-center w-full gap-3">
              {/* Get Quote button */}
              <button
                type="submit"
              ...
              {/* OR Divider */}
              <div className="flex items-center w-[350px] md:w-9/10">
                <div className="flex-1 h-px bg-white/30"></div>
                <span className="px-3 text-white/70 text-sm font-medium">OR</span>
                <div className="flex-1 h-px bg-white/30"></div>
              </div>

              {/* Get a Call from Us button */}
              <button
                type="button"
              ...
              >
                <svg className="w-7 h-7" fill="#F84734" stroke="#F84734" viewBox="0 0 24 24" strokeWidth={1} >
