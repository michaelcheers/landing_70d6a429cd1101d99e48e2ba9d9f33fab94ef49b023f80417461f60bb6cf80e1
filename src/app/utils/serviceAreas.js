// src/app/utils/serviceAreas.ts
export interface ServiceArea {
  city: string;
  province: string;
  region: string;
  branch: 'toronto' | 'vancouver';
  phone: string;
...
export const SERVICE_AREAS: Record<string, ServiceArea> = {
  ...
  'york': {
    ...
    branch: 'toronto',
    phone: '647-251-8188',
    coordinates: { lat: 43.6890, lng: -79.4467 },
    serviceRadius: 25,
    branchId: 'b8164028-c730-4fc4-912c-b1f4016f1130'
  },
...
// Helper function to get all service areas for a branch
export function getServiceAreasByBranch(branch: 'toronto' | 'vancouver'): Record<string, ServiceArea> {
  return Object.fromEntries(
    Object.entries(SERVICE_AREAS).filter(([, area]) => area.branch === branch)
  );
}

// Helper function to get all Ontario service areas
export function getOntarioServiceAreas(): Record<string, ServiceArea> {
  return Object.fromEntries(
