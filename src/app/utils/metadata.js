...
function generateSEOMetadata(config, pageType, customTitle, customDescription) {
  ...
  return {
    ...
    alternates: {
      canonical: pageType === "home" ? city === "Vancouver" ? "/vancouver" : city === "Ottawa" ? "/ottawa" : city === "Calgary" ? "/calgary" : city === "Edmonton" ? "/edmonton" : "/" : city === "Vancouver" ? `/vancouver/${pageType}` : city === "Ottawa" ? `/ottawa/${pageType}` : city === "Calgary" ? `/calgary/${pageType}` : city === "Edmonton" ? `/edmonton/${pageType}` : `/${pageType}`
    },
    other: {
