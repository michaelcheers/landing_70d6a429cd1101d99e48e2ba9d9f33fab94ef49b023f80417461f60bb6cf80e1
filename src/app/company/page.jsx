            ...
            <div className="flex flex-wrap w-full md:w-[1250px] px-6 md:px-0 mb-5 md:my-10 "> 
                <div className="w-full md:w-3/5 mt-10">
                    <div>
                        ...
                        phone Monday-Friday 8am - 11pm and Saturday-Sunday 9am - 9pm.
                        </p>
                    </div>
                    <div className="mt-8">
