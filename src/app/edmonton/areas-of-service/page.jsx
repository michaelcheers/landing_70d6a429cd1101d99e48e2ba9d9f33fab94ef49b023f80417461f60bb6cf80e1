...
const serviceAreas: Record<ServiceType, string[]> = {
  'local-moving': [
    ...
    'Gatineau', 'Saskatoon', 'Halifax', 'Regina', 'Edmonton', 'Edmonton', 'New Brunswick'
  ],
  'packing': [
    'Toronto', 'Hamilton', 'Oakville', 'Barrie', 'Oshawa', 'Mississauga', 'Pickering', 'Vaughan',
    'Scarborough', 'Caledon', 'Brampton', 'Milton', 'St. Catharines', 'London',
...
// Edmonton area cities for routing
...
// Function to sort locations with Edmonton areas first
const sortLocationsByRegion = (locations: string[], prioritizeEdmonton = true) => {
...
const ServiceAreasPage = () => {
  ...
  // Get sorted locations - you can change this to true for Edmonton pages
  const getSortedLocations = (serviceType: ServiceType) => {
    const locations = serviceAreas[serviceType] || [];
    return sortLocationsByRegion(locations, true); // Set to true for Edmonton pages
  };
