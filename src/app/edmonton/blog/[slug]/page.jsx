...
import CalHeader from "/src/app/components/edmonton/edmHeader.jsx";
import CalFooter from "/src/app/components/edmonton/edmFooter.jsx";
...
: {
  ...
  if (!post) {
    return {
      title: 'Blog Post Not Found - Moving Papa Edmonton',
      description: 'The requested blog post was not found.'
    };
  }

  return {
    title: `${post.title} | Moving Papa Edmonton Blogs`,
    description: post.excerpt,
    keywords: post.tags?.join(', ') || 'moving tips, Edmonton movers, Moving Papa',
    openGraph: {
      title: `${post.title} | Moving Papa Edmonton Blogs`,
      description: post.excerpt,
      type: 'article',
...
export default async function EdmontonBlogPost({
  params
}: {
  params: Promise<{ slug: string }>
}) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">
                  ...
                  helping Edmonton families and businesses with their relocation needs. We&apos;re committed to sharing our
      ...
      <div className="bg-[#F8F5EC] text-primary p-8 text-center w-full">
        ...
        <p className="mb-6">Get your free quote from Edmonton&apos;s trusted moving experts</p>
        <div className="flex flex-col md:flex-row justify-center gap-4">
          <Link href="/edmonton/finalstep/residential" className="bg-tertiary px-6 py-3 font-bold rainbow-button !rounded-xl text-center">
            GET A FREE QUOTE
          </Link>
