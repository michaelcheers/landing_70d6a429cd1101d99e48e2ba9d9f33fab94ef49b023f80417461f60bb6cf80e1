...
function Storage() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#F8F5EC]", children: [
    /* @__PURE__ */ jsx("div", { className: "w-full flex justify-center relative mt-13 md:mt-20", children: /* @__PURE__ */ jsx(BackgroundStorage, { children: /* @__PURE__ */ jsx("div", { className: "w-full flex justify-center", children: /* @__PURE__ */ jsx("div", { className: "w-full  md:w-[1440px] md:h-[700px] relative z-10 flex items-center", children: /* @__PURE__ */ jsxs("div", { className: "w-full pb-5 md:flex md:px-5 md:pt-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "pb-0 mb-0 w-screen md:w-1/2", children: /* @__PURE__ */ jsx("div", { className: "cols-span-1  mt-5 md:mt-10", children: /* @__PURE__ */ jsx(GetQuote, { from: "edmonton-storage" }) }) })
    ] }) }) }) }) }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(Link, { href: "/edmonton/finalstep/storage", className: "bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg", children: "Get a Quote" }) }),
    ...
    /* @__PURE__ */ jsx(GetQuoteFooter, { section: "edmonton-storage" })
  ] });
}
export {
  Storage as default
