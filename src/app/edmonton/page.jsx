import Header from "/src/app/components/edmonton/edmHeader.jsx";
...
const Footer = dynamic(()=>import("/src/app/components/edmonton/edmFooter.jsx"))
  ...
  return (
    <div className="bg-[#F8F5EC]" >
      ...
      <div className="flex flex-col items-center pt-5 md:pb-10 bg-primary">
        <VideoReview from="/edmonton/finalstep/residential"/>
      </div>
      ...
      <div className="my-10 mt-8">
        <MovingServicesGrid from="edmonton"/>
      </div>
