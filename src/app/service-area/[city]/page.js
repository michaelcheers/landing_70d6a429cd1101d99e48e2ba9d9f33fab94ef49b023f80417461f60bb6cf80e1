...
import VideoReview from "/src/app/components/videoReview.js";
...
const Review = dynamic(() => import("/src/app/components/review.js"));
async function ServiceAreaPage({ params }) {
  const { city } = await params;
  const serviceArea = getServiceAreaBySlug(city);
  if (!serviceArea) {
    notFound();
  }
  const { city: cityName, region, branch } = serviceArea;
  const isVancouver = branch === "vancouver";
  const fromProp = isVancouver ? "vancouver" : "toronto";
  const customHeadings = {
    mainHeading: `Professional Movers in ${cityName}`,
    subHeading: `Local Movers in ${cityName}`,
    trustLine: ``,
    description: `Moving in ${cityName} doesn't have to be hard - let us make it easy for you.`,
    serviceDescription: `Trusted moving services throughout ${cityName} and the ${region}.`
  };
  const questions = [
  ...
  const finalstepUrl = isVancouver ? "/vancouver/finalstep/residential" : "/finalstep/residential";
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#F8F5EC]", children: [
    /* @__PURE__ */ jsx(HamiltonTracker, { slug: city }),
    /* @__PURE__ */ jsx("div", { className: "fixed top-0 left-0 w-full z-10000", children: isVancouver ? /* @__PURE__ */ jsx(VanHeader, {}) : /* @__PURE__ */ jsx(Header, {}) }),
    /* @__PURE__ */ jsx("div", { className: "w-full hidden md:flex flex-col items-center relative mt-20", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[1400px] rounded-4xl flex flex-col justify-center items-center py-10 md:pt-5 md:pb-20 mx-2", children: [
      /* @__PURE__ */ jsx("div", { className: "font-bold flex flex-col items-center text-primary", children: /* @__PURE__ */ jsxs("div", { className: "hidden md:flex flex-col", children: [
        /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-4xl text-center", children: customHeadings.subHeading }),
        /* @__PURE__ */ jsxs("div", { className: "text-base md:text-lg font-regular mt-4 text-center", children: [
          customHeadings.description,
          /* @__PURE__ */ jsx("br", {}),
          /* @__PURE__ */ jsx("p", { className: "flex justify-center", children: "Get a free quote within minutes" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxs("div", { className: "w-10/11 max-w-[1200px] md:flex md:mt-5 justify-between", children: [
        /* @__PURE__ */ jsx("div", { className: "hidden md:flex items-center w-18/40", children: /* @__PURE__ */ jsx("div", { className: "flex", children: /* @__PURE__ */ jsx(Image, { src: Heart, alt: "Moving services" }) }) }),
        /* @__PURE__ */ jsx("div", { className: "w-full md:w-20/40", children: /* @__PURE__ */ jsx(GetQuote, { from: isVancouver ? "vancouver-moving" : "moving" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "w-full md:hidden pt-20", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center font-bold text-2xl", children: [
        /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx("h1", { className: "text-xl text-center", children: customHeadings.subHeading }) }),
        /* @__PURE__ */ jsx("p", { className: "text-base font-regular", children: customHeadings.description })
      ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-full", children: /* @__PURE__ */ jsx(GetQuote, { from: isVancouver ? "vancouver-moving" : "moving" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "w-full flex justify-center mt-6 md:mt-0", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden md:block w-7xl", children: /* @__PURE__ */ jsxs("div", { className: "pb-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "ml-2 pb-2 font-bold text-[16px] md:text-[22px] border-b-1 md:flex text-center", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-xl md:text-3xl font-bold text-primary", children: [
            "Hear from our ",
            cityName,
            " Customers, \xA0"
          ] }),
        ...
        /* @__PURE__ */ jsxs("div", { className: `grid grid-cols-2 ${city === "hamilton" ? "md:grid-cols-5" : "md:grid-cols-4"} mt-4 md:mt-8 gap-1 md:gap-x-4 font-bold md:w-8/10 mx-2`, children: [
          ...
          city === "hamilton" && /* @__PURE__ */ jsxs("div", { className: "bg-white border-2 pl-2 flex items-center h-[60px] rounded-lg", children: [
            /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center bg-primary w-[40px] h-[40px] relative rounded-lg", children: /* @__PURE__ */ jsx(Image, { src: GreenStorageLogo, alt: "", fill: true, sizes: "100%", style: { objectFit: "contain" } }) }),
            /* @__PURE__ */ jsx("div", { className: "ml-3 md:ml-2 text-[14px] font-regular md:text-[18px]", children: "Green Storage" })
          ] })
        ] })
      ] }) }),
      /* @__PURE__ */ jsx("div", { className: "md:hidden", children: /* @__PURE__ */ jsx(LogoCarousel, { city }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center pt-5", children: /* @__PURE__ */ jsx(Review, {}) }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center pt-5 md:pb-10 bg-primary", children: isVancouver ? /* @__PURE__ */ jsx(VideoReview, { from: "/vancouver/finalstep/residential" }) : /* @__PURE__ */ jsx(VideoReview, { from: "/finalstep/residential" }) }),
    ...
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(MovingServices, { from: fromProp }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "my-5 mb-15", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(Link, { href: finalstepUrl, className: "bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg", children: "Get a Quote" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "my-10 mt-8", children: /* @__PURE__ */ jsx(MovingServicesGrid, { from: fromProp }) }),
    /* @__PURE__ */ jsx("div", { className: "flex justify-center py-10", children: /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsx("div", { className: "flex items-start text-white pt-10 pl-5 md:pl-10 md:w-[1254px]", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-start justify-center", children: [
          ...
          /* @__PURE__ */ jsxs("h1", { className: "italic text-2xl md:text-4xl", children: [
            "Behind in ",
            cityName,
            "."
          ] }),
          /* @__PURE__ */ jsxs("span", { className: "text-base font-regular mt-4 text-start md:w-[490px] pr-6 md:pr-0", children: [
            "At Moving Papa, we believe every move in ",
            cityName,
            " should leave the smallest footprint possible. We use eco-friendly materials, efficient routes, and sustainable practices to reduce waste and emissions \u2014 without compromising service."
          ] })
        ] }) })
      }
    ) }),
    ...
    /* @__PURE__ */ jsx(GetQuoteFooter, {}),
    /* @__PURE__ */ jsx("div", { className: "px-1 bg-[#06170e]", children: isVancouver ? /* @__PURE__ */ jsx(VanFooter, {}) : /* @__PURE__ */ jsx(Footer, {}) })
  ] });
}
export {
