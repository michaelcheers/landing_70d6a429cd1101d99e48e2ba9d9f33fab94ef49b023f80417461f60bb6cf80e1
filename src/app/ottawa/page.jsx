import Header from "/src/app/components/ottawa/ottHeader.jsx";
...
const Footer = dynamic(()=>import("/src/app/components/ottawa/ottFooter.jsx"))
  ...
  return (
    <div className="bg-[#F8F5EC]" >
      ...
      <div className="flex flex-col items-center pt-5 md:pb-10 bg-primary">
        <VideoReview from="/ottawa/finalstep/residential"/>
      </div>
      ...
      <div className="my-5 mb-15">
        ...
        <div className="flex justify-center">
          <Link href="/ottawa/finalstep/residential" className="bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg">Get a Quote</Link>
        </div>
      </div>
      <div className="my-10 mt-8">
        <MovingServicesGrid from="ottawa"/>
      </div>
