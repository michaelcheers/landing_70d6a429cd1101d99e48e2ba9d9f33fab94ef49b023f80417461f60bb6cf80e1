...
: {
  ...
  if (!post) {
    return {
      title: 'Blog Post Not Found - Moving Papa Ottawa',
      description: 'The requested blog post was not found.'
    };
  }

  return {
    title: `${post.title} | Moving Papa Ottawa Blogs`,
    description: post.excerpt,
    keywords: post.tags?.join(', ') || 'moving tips, Ottawa movers, Moving Papa',
    openGraph: {
      title: `${post.title} | Moving Papa Ottawa Blogs`,
      description: post.excerpt,
      type: 'article',
...
export default async function OttawaBlogPost({
  params
}: {
  params: Promise<{ slug: string }>
}) {
  ...
  return (
    <div className="flex flex-col min-h-screen">
            ...
            <div className="mt-12 pt-8 border-t border-gray-200">
              <div className="bg-gray-50 rounded-lg p-6">
                ...
                <p className="text-gray-600">
                  ...
                  helping Ottawa families and businesses with their relocation needs. We&apos;re committed to sharing our
      ...
      <div className="bg-[#F8F5EC] text-primary p-8 text-center w-full">
        ...
        <p className="mb-6">Get your free quote from Ottawa&apos;s trusted moving experts</p>
