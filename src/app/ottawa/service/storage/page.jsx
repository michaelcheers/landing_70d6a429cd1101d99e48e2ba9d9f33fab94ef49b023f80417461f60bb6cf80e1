    ...
    return (
        <div className="bg-[#F8F5EC]">
            ...
            <div className="flex justify-center">
                <Link href="/ottawa/finalstep/storage" className="bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg">Get a Quote</Link>
            </div>
            {/* FAQ Section */}
            ...
            <GetQuoteFooter section="ottawa-storage"/>
        </div>
    )
}
