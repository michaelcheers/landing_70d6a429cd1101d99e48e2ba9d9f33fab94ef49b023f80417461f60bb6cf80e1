    ...
    return (
        <div className="bg-[#F8F5EC]">
                    ...
                    <div className="w-full  md:w-[1440px] md:h-[700px] relative z-10 flex items-center">
                        <div className="w-full pb-5 md:flex md:px-5 md:pt-10">
                            ...
                            <div className="cols-span-1  mt-5 md:mt-10">   
                                <GetQuote from="vancouver-storage"/>
                            </div>
                            </div>
                        </div>
                    </div>                    
            ...
            <div className="flex justify-center">
                <Link href="/vancouver/finalstep/storage" className="bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg">Get a Quote</Link>
            </div>
            {/* FAQ Section */}
            ...
            <GetQuoteFooter section="vancouver-storage"/>
        </div>
    )
}