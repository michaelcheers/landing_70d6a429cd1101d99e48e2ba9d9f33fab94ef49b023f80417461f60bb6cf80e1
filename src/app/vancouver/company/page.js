...
import Img_1 from "/src/images/elyse.webp.js";
import Img_2 from "/src/images/greg.webp.js";
function Contact() {
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center mt-13 md:mt-20", children: [
    /* @__PURE__ */ jsx("div", { className: "md:pb-10 w-screen flex flex-col items-center ", children: /* @__PURE__ */ jsx(BackgroundAboutUs, { children: /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-white p-6 md:p-10 md:pl-20 md:h-100 md:w-[1250px] flex flex-col justify-center", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-center w-full bg-primary", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap w-full md:w-[1250px] justify-center  my-10 ", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap w-full md:w-[1250px] px-6 md:px-0 mb-5 md:my-10 ", children: [
      /* @__PURE__ */ jsxs("div", { className: "w-full md:w-3/5 mt-10", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h2", { className: "text-primary text-2xl font-bold", children: "Call Us Now Or Leave Us a Message" }),
          /* @__PURE__ */ jsx("p", { className: "font-regular text-regular ", children: "We are open 24/7 365 a year, offering 7 days a week support with real people picking up the phone Monday-Friday 8am - 8pm and Saturday-Sunday 8am - 6pm." })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-primary text-2xl font-bold", children: "Get Your Free Quote Today" }),
          /* @__PURE__ */ jsx("p", { className: "font-regular text-regular", children: "Contact us anytime to speak to our experienced moving consultants who will provide you with a guaranteed flat price, obligation free, moving quote." }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-x-10 gap-y-4 w-full justify-center mt-10", children: [
            /* @__PURE__ */ jsx(Link, { href: "/vancouver/finalstep/residential", className: "w-8/10 md:w-1/3", children: /* @__PURE__ */ jsx("button", { className: "bg-primary text-white px-10 py-4 hover:cursor-pointer w-full rainbow-button font-bold !rounded-xl", children: "GET A FREE QUOTE" }) }),
            /* @__PURE__ */ jsx("a", { href: "tel:6043735582", className: "w-8/10 md:w-1/3", children: /* @__PURE__ */ jsxs("button", { className: "bg-primary text-white px-10 py-4 flex w-full justify-center hover:cursor-pointer rounded-xl", children: [
              /* @__PURE__ */ jsx(PhoneIcon, { className: "h-6 w-6 mr-1 text-white", fill: "white", strokeWidth: 2 }),
              "604-373-5582"
            ] }) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "w=2/5 hidden md:flex", children: /* @__PURE__ */ jsx(
        Image,
        {
          src: Img_1,
          alt: "",
    ...
    /* @__PURE__ */ jsxs("div", { className: "md:w-[1300px] bg-primary rounded-lg p-6 mx-2 md:mx-0", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-tertiary text-2xl font-bold", children: "Interested in joining the team" }),
      /* @__PURE__ */ jsxs("p", { className: "font-regular text-base text-white", children: [
        "We are always looking for talent like you in our sales, marketing, admin support, operations and moving teams.",
        /* @__PURE__ */ jsx("br", {}),
        "careers@movingpapa.com"
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "md:w-[1250px] w-full my-5 px-6 md:px-0", children: [
      /* @__PURE__ */ jsx("h2", { className: "text-primary text-2xl font-bold", children: "Business Inquiries" }),
      /* @__PURE__ */ jsxs("div", { className: "font-regular text-base md:flex", children: [
        "For all other business and inquiries please email\xA0 ",
        /* @__PURE__ */ jsx("p", { className: "text-tertiary", children: "hello@movingpapa.com" })
      ] })
    ] })
  ] });
}
