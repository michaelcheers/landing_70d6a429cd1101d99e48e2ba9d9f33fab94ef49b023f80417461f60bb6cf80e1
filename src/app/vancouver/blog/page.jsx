...
export default function VancouverBlogPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="flex justify-center">
            <div className="text-white p-6 md:p-10 md:pl-20 md:h-100 md:w-[1250px] flex flex-col justify-center">
              ...
              <p className="text-regular font-bold">
                Expert insights and practical advice from Vancouver&apos;s trusted moving professionals
              </p>
            </div>
          </div>
        </BackgroundAboutUs>
                  ...
                  <div className="p-6">
                    ...
                    <div className="mb-4">
                      ...
                      <h2 className="text-xl font-bold text-primary mb-3 leading-tight">
                        <Link href={`/vancouver/blog/${post.slug}`} className="hover:underline">
                          {post.title}
                        </Link>
                      </h2>
                    </div>
      ...
      <div className="bg-[#F8F5EC] text-primary p-8 text-center w-full">
        ...
        <p className="mb-6">Let Moving Papa make your Vancouver move stress-free and efficient</p>
