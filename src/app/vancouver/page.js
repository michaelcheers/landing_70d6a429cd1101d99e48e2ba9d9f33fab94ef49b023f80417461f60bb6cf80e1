...
const Footer = dynamic(() => import("/src/app/components/vancouver/vanFooter.js"));
...
function Home() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#F8F5EC]", children: [
    /* @__PURE__ */ jsx("span", { style: { display: "none" }, id: "deploy-check-abc123", children: "deployed" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full hidden md:flex flex-col items-center relative mt-20", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[1400px] rounded-4xl flex flex-col justify-center items-center py-10 md:pt-5 md:pb-20 mx-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-10/11 max-w-[1200px] md:flex md:mt-5 justify-between", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-full md:w-20/40", children: /* @__PURE__ */ jsx(GetQuote, { from: "vancouver-moving" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "w-full md:hidden pt-20", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-full", children: /* @__PURE__ */ jsx(GetQuote, { from: "vancouver-moving" }) })
    ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center pt-5 md:pb-10 bg-primary", children: /* @__PURE__ */ jsx(VideoReview, { from: "/vancouver/finalstep/residential" }) }),
    ...
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(MovingServices, { from: "vancouver" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "my-5 mb-15", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx(Link, { href: "/vancouver/finalstep/residential", className: "bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg", children: "Get a Quote" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "my-10 mt-8", children: /* @__PURE__ */ jsx(MovingServicesGrid, { from: "vancouver" }) }),
    ...
    /* @__PURE__ */ jsx(GetQuoteFooter, { section: "vancouver-moving" }),
