...
export default function Reviews() {
  // Review data - using the same data from your review component
    const reviews = [
    {
        id: 4,
  ...
  return (
    <div className="flex flex-col items-center mt-13 md:mt-20">
        ...
        <BackgroundAboutUs>
          <div className="flex justify-center">
            <div className="text-white p-6 md:p-10 md:pl-20 md:h-100 md:w-[1250px] flex flex-col justify-center">
              <h1 className="text-4xl font-bold py-8">Our Customer Reviews</h1>
              <p className="text-regular font-bold">
                See what our customers have to say about their moving experience with Moving Papa
              </p>
            </div>
          </div>
        </BackgroundAboutUs>
      ...
      {/* Reviews Section */}
      <div className="w-full max-w-[1000px] py-10 px-4 md:px-0">
        {/* Google Rating Display */}
        <div className="w-full flex justify-center items-center mb-10">
          <div className="bg-white p-4 rounded-xl border-t-4 border-[#34A853] shadow-lg flex items-center">
            <div>
            ...
            <div className="ml-4">
              <h3 className="text-primary font-bold text-xl">Google Top Rated Service</h3>
              <div className="flex items-center">
                <span className="text-[#FEA500] text-2xl font-bold">4.9</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviews.map((review) => (
            <div key={review.id} className="border-1 border-primary rounded-4xl flex flex-col h-[400px]">
              <div className="p-4 flex flex-col h-full">
                ...
                <div className="text-primary font-reg pt-4 flex-grow text-sm">
                  <p>{review.text}</p>
                </div>
        ...
        {/* Call to Action */}
        <div className=" bg-[#F8F5EC] text-primary p-8 text-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Ready to experience our top-rated moving service?</h2>
          <p className="mb-6">Join the hundreds of satisfied customers who trusted Moving Papa with their move</p>
          <div className="flex flex-col md:flex-row justify-center gap-4">
            <a href="/vancouver/finalstep/residential" className="bg-tertiary px-6 py-3 font-bold rainbow-button !rounded-xl text-center">
              GET A FREE QUOTE
            </a>
            <a href="tel:6043735582" className="bg-tertiary text-white px-6 py-3 rounded-xl font-bold flex items-center justify-center">
