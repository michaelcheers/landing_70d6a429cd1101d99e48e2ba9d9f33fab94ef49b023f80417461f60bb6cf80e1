...
// const ContactSection = dynamic(()=> import("/src/app/components/contactForm.jsx"))
const Footer = dynamic(()=>import("/src/app/components/footer.jsx"))
const PapaAdv = dynamic(()=>import("/src/app/components/papaadv.jsx"))
// const AreasOfService = dynamic(()=>import("/src/app/components/serviceArea.jsx"))
const MovingServicesGrid = dynamic(()=>import("/src/app/components/movingService.jsx"))
// const Schedule = dynamic(()=>import("/src/app/components/schedule.jsx"))
...
export default function Home() {
  ...
  return (
    <div className="bg-[#F8F5EC]" >
      ...
      <div className="w-full md:hidden pt-20">
        <div className="text-center font-bold text-2xl">
          <div>
              ...
              <div className="flex text-[21px]  justify-center">
                But <p className="text-tertiary">&nbsp;only one Moving Papa</p>
              </div>    
          </div>
      ...
      {/* Review */}
      <div className="flex flex-col items-center pt-5 md:pb-10">
        <Review/>
      </div>
