    ...
    return (
        <div className="bg-[#F8F5EC]">
            ...
            <div className="flex justify-center mb-10">
                <Link href="/finalstep/storage" className="bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg">Get a Quote</Link>
            </div>
