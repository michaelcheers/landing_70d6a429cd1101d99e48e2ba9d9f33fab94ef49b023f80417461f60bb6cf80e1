  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-[#F8F5EC]", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "w-full hidden md:flex flex-col items-center relative mt-20", children: /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[1400px] rounded-4xl flex flex-col justify-center items-center py-10 md:pt-5 md:pb-20 mx-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "w-10/11 max-w-[1200px] md:flex md:mt-5 justify-between", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "w-full md:w-20/40", children: /* @__PURE__ */ jsx(GetQuote, { from: "landing" }) })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "w-full md:hidden pt-20", children: [
      /* @__PURE__ */ jsxs("div", { className: "text-center font-bold text-2xl", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("h1", { className: "text-[21px] text-center ", children: "There are lots of moving companies" }),
          /* @__PURE__ */ jsxs("div", { className: "flex text-[21px]  justify-center", children: [
            "But ",
            /* @__PURE__ */ jsx("p", { className: "text-tertiary", children: "\xA0only one Moving Papa" })
          ] })
        ] }),
      ...
      /* @__PURE__ */ jsx("div", { className: "max-w-full", children: /* @__PURE__ */ jsx(GetQuote, { from: "landing" }) })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "w-full flex justify-center mt-6 md:mt-0", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden md:block w-7xl", children: /* @__PURE__ */ jsxs("div", { className: " pb-10", children: [
        /* @__PURE__ */ jsxs("div", { className: "ml-2  pb-2 font-bold text-[16px] md:text-[22px] border-b-1 md:flex text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "text-2xl md:text-3xl font-bold text-primary", children: "Hear from our Customers, \xA0" }),
          /* @__PURE__ */ jsx("div", { className: "text-2xl md:text-3xl font-bold text-tertiary", children: "the heart of our Success." })
        ] }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center pt-5 md:pb-10", children: /* @__PURE__ */ jsx(Review, {}) }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center pt-5 md:pb-10 bg-primary", children: /* @__PURE__ */ jsx(VideoReview, { from: "/finalstep/residential" }) }),
    ...
    /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(MovingServices, {}) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "my-5 mb-15", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex flex-col md:flex-row gap-3 justify-center items-center", children: /* @__PURE__ */ jsx(Link, { href: "/finalstep/residential", className: "bg-tertiary font-bold text-white w-8/10 md:w-1/3 py-3 text-center rainbow-button !rounded-lg", children: "Get a Quote" }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "my-10 mt-8", children: /* @__PURE__ */ jsx(MovingServicesGrid, {}) }),
